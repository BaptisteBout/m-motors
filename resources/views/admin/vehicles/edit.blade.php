                ...
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="mb-0 text-dark fw-bold">
                            <i class="bi bi-pencil-square text-primary me-2"></i>Modifier : {{ $vehicle->brand }} {{ $vehicle->model }}
                        </h5>
                    </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="acquisition_type" class="form-select @error('acquisition_type') is-invalid @enderror" required>
                                        <option value="Achat" {{ old('acquisition_type', $vehicle->acquisition_type) == 'Achat' ? 'selected' : '' }}>Achat</option>
                                        <option value="Location" {{ old('acquisition_type', $vehicle->acquisition_type) == 'Location' ? 'selected' : '' }}>Location</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" name="price_purchase" class="form-control @error('price_purchase') is-invalid @enderror" value="{{ old('price_purchase', $vehicle->price_purchase) }}" required>
